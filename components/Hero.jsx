        ...
        <section className="hero_banner">
            <div className="hero">
                ...
                <div className="hero_text container container-no-top-margin">
                    ...
                    <ul>
                        <li><a href="https://drive.google.com/file/d/1_6ohs6caOxGdl8Ur56IdRCzNVmcjdPlh/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button type="button">Resume <i className="fa fa-external-link"></i></button></a></li>
